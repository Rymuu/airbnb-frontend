        ...
        <div className={styles.page__details}>
            <div className={styles.grid__container}>
                <div className={styles.item1}>
                    {place.images?.[0] && (
                        <img onClick={() => setShowAllPhotos(true)} src={place.images[0]} alt="" />
                    )}
                </div>
                <div className={styles.item2}>
                    {place.images?.[1] && (
                        <img onClick={() => setShowAllPhotos(true)} src={place.images[1]} alt="" />
                    )}
                </div>
                <div  className={styles.item3}>
                    {place.images?.[2] && (
                        <img onClick={() => setShowAllPhotos(true)} src={place.images[2]} alt="" />
                    )}
                </div>
            </div>
